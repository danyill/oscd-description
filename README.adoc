...
:uri-plugin: https://github.com/danyill/oscd-description
:uri-ci-bundle: https://danyill.github.io/oscd-description/oscd-description.js
:uri-material-icons: https://fonts.google.com/icons
:uri-openscd-core-plugin-demo: https://danyill.github.io/oscd-description/index.deploy.html
...
For a local resource, begins without a forward slash, e.g. `plugins/oscd-description/dist/oscd-description.js`. 
...
<.> Whether a document must be loaded for this plugin to be available
<.> URL which can be a local or remote resource. 
For a local resource, begins with a forward slash, e.g. `plugins/oscd-description/dist/oscd-description.js`. 
